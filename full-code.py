...
model = load_model(r'files\model_last40.h5')

cap = cv2.VideoCapture('data/videos/video_11.mp4')
...
while(cap.isOpened()):
    ...
    if ret == True :
        ...
        for i in range(len(outs)):
            ...
            print(ym)
            if ym==1:
                cv2.rectangle(copy, (x, y), (x + w, y + h), (255,255,255), 2) #white
            elif ym==0:
                cv2.rectangle(copy, (x, y), (x + w, y + h), (255,0,0), 2) #blue
            elif ym==2:
                cv2.rectangle(copy, (x, y), (x + w, y + h), (0,0,255), 2) #red
            elif ym==3:
                cv2.rectangle(copy, (x, y), (x + w, y + h), (0,165,255), 2) #orange
            elif ym==4:
                cv2.rectangle(copy, (x, y), (x + w, y + h), (0,0,0), 2) #black
            elif ym==5:
                cv2.rectangle(copy, (x, y), (x + w, y + h), (165,0,0), 2) #light blue
            elif ym==6:
                cv2.rectangle(copy, (x, y), (x + w, y + h), (0,255,0), 2) #green
